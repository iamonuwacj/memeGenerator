      ...
      <div className=''>
        <div className="main-content">
          <div className="sidebar">
            ...
            <p>
              Meme project inspired by imgflip.
            </p>
            <p>To begin, click on the meme template that you want to use and start editing.</p>
            <p>
              You can add text to both top and bottom on a meme template, move the text around and can save the image by downloading it.
            </p>
          </div>
